                        ...
                        <ol class="breadcrumb breadcrumb-style2 mb-0">
                            <li class="breadcrumb-item">
                                <a href="javascript:void(0);">
                                    <i class="ri-contacts-book-3-line me-1 fs-15"></i>
                            ...
                            <ul class="nav nav-tabs nav-tabs-header mb-0 mailsettings-nav d-flex gap-2" role="tablist">
                                ...
                                <li class="nav-item m-1">
                                    <a class="nav-link" data-bs-toggle="tab" role="tab" aria-current="page"
                                        ...
                                        {{ __("view.employee.account") }}
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <form id="profile-employee-form"
                            action="{{ route('employees.profile', $employee) }}"
                                            ...
                                            <div class="col-xl-2 col-12">
                                                <div class="col-12 mt-4">
                                                    <span class="avatar avatar-xxl p-1 bg-light border avatar-rounded">
                                                        <img src="{{ old(
                                                            'avatar_url',
                                                            $employee->avatar_url ? asset('storage/' . $employee->avatar_url) : asset('images/employee/avatar.png'),
                                                        ) }}"
                                                            alt="" id="edit-avatar_url">
                                                        <span class="badge rounded-pill bg-purple avatar-badge">
                                                            <input type="file" name="avatar_url" accept="image/*"
                                                                class="position-absolute w-100 h-100 op-0" id="avatar_url">
                                            ...
                                            <div class="col-xl-10 col-12 p-0 m-0">
                                                <div class="row p-0 m-0">
                                                    <div class="col-xl-6 col-12">
                                                        ...
                                                        <input type="text" class="form-control" id="edit-frist_name"
                                                            name="frist_name"
                                                            value="{{ old('frist_name', $employee->frist_name) }}">
                                                    ...
                                                    <div class=" col-xl-6 col-12">
                                                        ...
                                                        <input type="text" class="form-control" id="edit-last_name"
                                                            name="last_name"
                                                    ...
                                                    <div class="col-12 mt-2">
                                                        ...
                                                        <input type="text" class="form-control" id="edit-phone_number"
                                                            name="phone_number"
                                                    ...
                                                    <div class="col-xl-6 col-12 mt-2">
                                                        ...
                                                        <select name="role_id" class="form-control" id="edit-role_id">
                            ...
                            <div class="card-footer text-end pd-2">
