                        ...
                        <div class="o9v6fnle cxmmr5t8 oygrvhab hcukyx3x c1et5uql ii04i59q">
                            <div dir="auto">
                                ️<span
                                    ...
                                    <img alt="{{ $post->slug }}" referrerpolicy="origin-when-cross-origin" src="{{ asset('storage/' . $post->thumbnail) }}"></span>
                            </div>
                        </div>
                        <div class="o9v6fnle cxmmr5t8 oygrvhab hcukyx3x c1et5uql ii04i59q">
                    ...
                    <div class="bor-box-related lpost-box">
                        @foreach ($new_bodys as $new_body)
                            <div class="sb-post clearfix sb-post-related pd-2">
                                <a class="img hv-scale" href="{{ route('news.detail', $new_body->slug) }}"
                                    title="{{ $new_body->slug }}">
                                    <img class="lazy" src="{{ asset('storage/' . $new_body->thumbnail) }}" alt="{{ $new_body->slug }}">
                                </a>
                                <div class="ct mt-2 mr-2">
                                    <h3 class="title cate_related_post">
                                        <a class="smooth" href="{{ route('news.detail', $new_body->slug) }}"
                                            title="{{ $new_body->slug }}">
                                            {{ $new_body->title }}
                                        </a>
                                    </h3>
                                    <p>{!! $new_body->description !!}</p>
                                </div>
                            </div>
                        @endforeach
