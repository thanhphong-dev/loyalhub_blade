...
@section('content')
    <div class="banner">
        <img src="{{ asset('assets/images/storage/thum/seo-google.png') }}" alt="">
    </div>
    ...
    <div class="container page_details_featured">
        <div class="headbox">
            <h2 class="title"><span>Giải pháp SEO Google toàn diện tại Wind Lập Trình</span> <br></h2>
            <p>
                Tăng trưởng thứ hạng bền vững, tiếp cận đúng khách hàng, chuyển đổi cao. Wind Lập Trình đồng hành
                cùng doanh nghiệp trên hành trình chinh phục top Google hiệu quả và dài hạn
            </p>
        </div>
    </div>
                ...
                <div class="row grid-feature">
                    @if ($loop->iteration % 2 == 1)
                        <div class="col-md-6 order2">
                            <div class="hv-scale">
                                <img src="{{ asset('storage/'. $seo->thumbnail) }}" caption="false" width="570" height="503">
                            </div>
                        </div>
                        <div class="col-md-6 order1">
                            <div class="i-title">{{ $seo->title }}</div>
                            <div class="desc">
                                <p>{{ $seo->description }}</p>
                            </div>
                        </div>
