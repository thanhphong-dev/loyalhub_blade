                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style2 mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('view.customer.contact') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                        ...
                                                        <div class="col-xl-6 col-12">
                                                            ...
                                                            <select name="status" class="form-control" id="edit-status">
                                                                @foreach ($customerStatus as $status)
                                                                    @if (in_array($status, App\Enums\CustomerStatus::groupContacted()))
