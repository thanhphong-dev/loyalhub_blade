                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style2 mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);"><i
                                        class="ri-folder-open-line me-1 fs-15"></i>{{ __('view.category_posts.category') }}</a></li>
                    ...
                    <div class="card custom-card">
                        <div class="card-header justify-content-between">
                            <div class="card-title">
                                {{ __('view.category_posts.category_parent') }}
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <form action="#">
                                        <div class="input-group">
                                            <input type="text" class="form-control form-control-sm" name="keyword"
                                                value="" placeholder="tìm kiếm danh mục..."
                                                aria-label="tìm kiếm danh mục..." aria-describedby="btn-search">
                                            <button class="btn btn-primary btn-wave" type="submit" id="btn-search">
                                            ...
                                            @foreach ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        src="{{ $category->image !=null ?  asset('storage/'. $category->image) : asset('images/icon/icon-category.png') }}" />
                                                    </td>
                                                    <th scope="row">
                                                        <a href={{ $category->children->count() > 0 ? route('category_posts.sub_category', $category->id) : '#' }}
                                                    ...
                                                    <td class="text-center">
                                                        <div class="hstack gap-2 fs-15">
                                                            <button
                                                                class="btn btn-icon btn-sm btn-primary btn-edit-category-post"
                                                                data-id="{{ $category->id }}"
                                                                data-name="{{ $category->name }}"
                                                                data-parent_id="{{ $category->parent_id }}"
                                                                data-note="{{ $category->note }}" type="button"
                                                                data-toggle="tooltip" data-placement="top"
                                                                title="Edit">
                                                                <i class="ri-edit-line"></i>
                                                            </button>

                                                            <a href="{{ route('category_posts.destroy', $category->id) }}"
