                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style2 mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);"><i
                                        class="ri-draft-line me-1 fs-15"></i>Bài viết</a></li>
                            ...
                            <div class="row pd-0 mr-0 mb-2 align-items-center">
                                ...
                                <div class="col-12 col-xl-9 text-xl-end text-start">
                                    <button class="btn btn-sm btn-primary btn-wave waves-light" data-bs-toggle="modal"
                                        data-bs-target="#create-posts">
                                        <i class="ri-add-line fw-medium align-middle me-1"></i> Bài viết
                                    </button>

                                </div>
                                <!-- Start::add posts modal -->
                                <div class="modal modal-lg fade mr-0" id="create-posts" tabindex="-1" aria-hidden="true">
                                                ...
                                                <div class="modal-body px-4">
                                                    <div class="row gy-2">
                                                        <div class="col-xl-6 col-12">
                                                            <label for="title"
                                                                class="form-label">{{ __('view.posts.title') }}</label>
                                                        ...
                                                        <div class="col-xl-6 col-12">
                                                            <label class="form-label">{{ __('view.posts.status') }}</label>
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label for="description"
                                                                class="form-label">{{ __('view.posts.description') }}</label>
                                                            <textarea class="form-control" id="description" name="description" placeholder="nhập nội dung..." rows="3"></textarea>
                                                        </div>
                                                        <div class="col-xl-12">
                                                            <label for="content"
                                                                class="form-label">{{ __('view.posts.content') }}</label>
                                                        ...
                                                        <div class="col-xl-6 col-12">
                                                            <label
                                                                class="form-label">{{ __('view.posts.category') }}</label>
                                                        ...
                                                        <div class="col-xl-6 col-12">
                                                            <label
                                                                class="form-label">{{ __('view.posts.section') }}</label>
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label class="form-label">{{ __('view.posts.type') }}</label>
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label for="thumbnail"
                                                                class="form-label">{{ __('view.posts.thumbnail') }}</label>
                                ...
                                <div class="modal modal-lg fade mr-0" id="editPostModal" tabindex="-1"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <form action="{{ route('posts.update') }}" method="post"
                                                ...
                                                <div class="modal-body px-4">
                                                    ...
                                                    <div class="row gy-2">
                                                        ...
                                                        <div class="col-xl-6 col-12">
                                                            <label
                                                                class="form-label">{{ __('view.posts.status') }}</label>
                                                            <select name="status" class="form-control" id="status">
                                                                @foreach ($postStatus as $item)
                                                                    <option value="{{ $item->value }}">
                                                                        {{ $item->lable() }}
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap table-bordered border-primary table-checkall mb-2">
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
                                            <th scope="col">{{ __('view.posts.section') }}</th>
                                            <th scope="col">{{ __('view.posts.type') }}</th>
                                            <th scope="col">{{ __('view.posts.thumbnail') }}</th>
                                            <th scope="col">{{ __('view.posts.title') }}</th>
                                            <th scope="col">{{ __('view.posts.slug') }}</th>
                                            <th scope="col">{{ __('view.posts.description') }}</th>
                                            <th scope="col">{{ __('view.posts.content') }}</th>
                                            <th scope="col">{{ __('view.posts.category') }}</th>
                                            <th scope="col">{{ __('view.posts.status') }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($posts as $post)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge text-wihte {{ $color }} ">
                                                        {{ $post->section->key }}
                                                    </span>
                                                </td>
                                                <td>
                                                ...
                                                <td scope="row">
                                                    <img class="avatar avatar-xl p-1"
                                                        src="{{ $post->thumbnail != null ? asset('storage/' . $post->thumbnail) : asset('images/icon/icon-image.png') }}" />
                                                </td>
                                                <td>
                                                    {{ $post->title }}
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-icon btn-sm btn-primary btn-edit-post"
                                                        data-id="{{ $post->id }}"
                                                        ...
                                                        data-type="{{ $post->type }}"
                                                        data-status="{{ $post->status }}" type="button"
                                                    ...
                                                    <a href="{{ route('posts.destroy', $post->id) }}"
                                                        ...
                                                        <i data-id="{{ $post->id }}" class="ri-delete-bin-line"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                        @empty
