...
function setNavActive() {
    ...
    let currentPath = path.replace(/^\/+/, "") || "admin";
    ...
    sidemenuItems.forEach((menuItem) => {
        let menuHref = menuItem.getAttribute("href");

        let menuPath = menuHref && menuHref !== "javascript:void(0);"
            ? (new URL(menuHref, window.location.origin)).pathname.replace(/^\/+/, "")
            : null;
